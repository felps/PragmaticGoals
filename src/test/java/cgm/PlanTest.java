...
public class PlanTest {
    ...
    public void shouldAddAnotherTaskSequentially() {
        WorkflowTask task1 = new WorkflowTask("initial");
        WorkflowTask task2 = new WorkflowTask("final");
    ...
    public void shouldAddAnotherTaskInterleaved() {
        WorkflowTask task1 = new WorkflowTask("initial1");
        WorkflowTask task2 = new WorkflowTask("initial2");
